...
export default function ChapterExecutionQueueCard(props: ChapterExecutionQueueCardProps) {
  ...
  return (
    <Card className="flex flex-col h-full overflow-hidden border-border/70 lg:sticky lg:top-4">
      ...
      <CardContent className="flex flex-1 min-h-0 flex-col pt-4 pb-0">
        <div className="min-h-0 flex-1 space-y-3 overflow-y-auto pr-1 pb-16">
          {chapters.length === 0 ? (
