...
> {
  ...
  return {
    ...
    render: (_input, context) => [
      new SystemMessage([
        "你是网文分卷策略规划助手。",
        "你的任务不是直接生成最终分卷骨架，而是先确定整本书应分几卷、哪些卷需要硬规划、哪些卷只保留软规划，并给出一套符合目标篇幅的分卷策略。",
        "",
        "【任务边界】",
        ...
        "如果 chapter budget 只有 1-5 章，必须按短篇闭环处理，通常只规划 1 卷，不得为了中段续航、后段升级空间或长期连载弹性而扩卷。",
        "",
        "【核心目标】",
        "1. strategy 必须优先服务目标篇幅内的阅读完成感与追读动力，不得把短篇硬套成长篇结构。",
        "2. 分卷策略必须兼顾开书抓力、阶段兑现与后续可调度性；短篇应优先闭环，长篇才强调中段续航和后段升级空间。",
        "3. hard 规划用于锁定前期最关键的承诺、卖点、推进秩序与节奏稳定性。",
        "4. soft 规划用于保留后续卷的弹性，方便根据连载反馈、篇幅变化、卖点强化和剧情自然增长进行调整；短篇没有后续卷时不需要制造 soft 卷。",
        "",
        "【规划原则】",
        ...
        "6. 1-5 章短篇应把开局抓手、转向、高潮和收束压缩在目标章数内完成，不要额外规划中段续航卷或下一阶段入口卷。",
        "",
        "【重点判断项】",
      ...
      new HumanMessage([
        ...
        "- 优先保证目标篇幅内的前期抓力、阶段兑现与结构可执行性；短篇不要强行拆成长篇节奏",
        "",
        "【规划上下文】",
