...
> {
  return {
    ...
    render: (_input, context) => [
      new SystemMessage([
        "你是网文分卷骨架规划助手，负责把整本书的上游策略拆解为可执行的卷级骨架。",
        "",
        "【任务边界】",
        ...
        "5. 如果 chapter budget 只有 1-5 章或目标只有 1 卷，必须按短篇闭环处理，不要把短篇硬扩成长篇分卷。",
        "",
        "【分卷质量要求】",
        ...
        "6. 短篇单卷可以把 openingHook、midVolumeRisk、climax、resetPoint 压缩为同一条闭环中的不同职责；不要为了字段完整而虚构独立中段或下一卷。",
        "",
        "【节奏要求】",
        ...
        "5. 当目标篇幅是短篇闭环时，nextVolumeHook 可以写成轻量余波或“无下一卷，收束在当前卷”；不得因此新增下一卷入口。",
        "",
        "【禁止事项】",
        "禁止脱离上下文自行发明大设定。",
      ...
      new HumanMessage([
        ...
        "- 如果目标是 1-5 章短篇，优先保证单卷闭环，不要强行规划长篇中段或后续卷入口",
        "",
        "【分卷骨架上下文】",
        renderSelectedContextBlocks(context),
      ].join("\n")),
